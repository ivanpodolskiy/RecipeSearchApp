...
class FilterViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        setupSubviewsWithLayout()
        activateActionsForButtons()
    ...
    private func setupSubviewsWithLayout() {
        ...
        backgroundCollectionView.addSubview(FilterCV)
    ...
    private func activateLayoutConstraint() {
        NSLayoutConstraint.activate([
            ...
            FilterCV.topAnchor.constraint(equalTo: lineView.bottomAnchor, constant: 3),
            FilterCV.leftAnchor.constraint(equalTo: backgroundCollectionView.leftAnchor, constant: 5),
            FilterCV.rightAnchor.constraint(equalTo: backgroundCollectionView.rightAnchor, constant: -5),
            FilterCV.bottomAnchor.constraint(equalTo: backgroundCollectionView.bottomAnchor)
        ])
    }
    
    private func activateActionsForButtons() {
...
extension FilterViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let categoryValues = categoryValues else { return cell }
...
extension FilterViewController: UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForSectionAt section: Int) -> UIEdgeInsets {
        ...
        let totalSpacing = minimumSpacing + maximumSpacing
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        guard let categoryValues = categoryValues, let font = UIFont(name: "Helvetica", size: 18) else { return CGSize(width: 0, height: 0) }
        let valueTitle = categoryValues[indexPath.row].title
        let fontAttributes = [NSAttributedString.Key.font: font]
        let size = (valueTitle as NSString).size(withAttributes: fontAttributes)
...
extension FilterViewController: FilterViewDelegate  {
    func updateCategoryView(categoryType: CategoryType) {
        updateValueWithAnimation(use: categoryType)
    }
    
    private func updateValueWithAnimation(use categoryType: CategoryType) {
