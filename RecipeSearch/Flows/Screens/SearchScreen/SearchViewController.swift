...
class SearchViewController: UIViewController{
    ...
    init(filterVC: FilterViewController, recipesCollection: RecipesViewController) {
        self.filterController = filterVC
        self.collectionView = recipesCollection
...
extension SearchViewController: UISearchBarDelegate {
    ...
    func searchBarBookmarkButtonClicked(_ searchBar: UISearchBar) {
        ...
        if filterController.view.isDescendant(of: view)  {
