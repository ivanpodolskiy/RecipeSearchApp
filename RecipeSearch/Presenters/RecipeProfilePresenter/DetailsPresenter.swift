...
protocol DetailsPresenterProtocol: PresenterProtocol, FavoriteStatusProtocol, NavigationWebViewProtocol  {
    func loadData()
    func loadImage()
}
...
protocol DetailsPresenterDelegate: AnyObject, UIViewController, NavigationDelegate, WebErrorProtocol, SheetDelegate  {
...
class DetailsPresenter: DetailsPresenterProtocol {
    ...
    weak var delegateView: DetailsPresenterDelegate?
    ...
    func attachView(_ view: UIViewController) {
        delegateView = view as? DetailsPresenterDelegate
    }
