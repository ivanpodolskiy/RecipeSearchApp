...
extension FavoriteRecipesPresenter: RecipeNavigationProtocol {
    func pushRecipeProfileScreen(with recipeProfile: RecipeProfileProtocol, onStatusUpdate:  UpdatedStatusCallback?) {
        let profileVC = getPreparedViewController(recipeProfile: recipeProfile, onStatusUpdate: onStatusUpdate)
        favoriteRecipesController?.pushViewController(profileVC, animated: true)
    }
    
    private func getPreparedViewController(recipeProfile: RecipeProfileProtocol, onStatusUpdate:  UpdatedStatusCallback?) -> UIViewController{
